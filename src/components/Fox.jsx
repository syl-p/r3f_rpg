...
const fox = forwardRef(function Fox(props,  groupRef) {
  const tpsCameraUpdate = useTpsCamera(groupRef, new THREE.Vector3(-3.5, 5, -7.5), new THREE.Vector3(0, 5, 6))
  ...
  const handleMovements = (delta) => {
    ...
    const _R = groupRef.current.quaternion.clone();
